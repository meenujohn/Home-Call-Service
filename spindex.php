...
<body>
	...
	<!-- //header -->
	<div class="banner-bg21">
		<div class="banner-info bg3 inner">

			<h3 style="color: blue;">Welcome</h3>
			<p style="color: black;">repair.&nbsp;improve.&nbsp;maintain</p>
		</div>
	</div>
	<!-- breadcrumbs -->
...
We continually updating our technicians training in order to ensure that your repairs will be completed by a knowledgeable technician.</p>
	...
	<div class="about-slid">
		<div class="container">
			<h6 class="slid">Professional, Efficient and Reliable  Services</h6>
		</div>
	</div>
	<!-- //about-slid -->
	<!-- what we do -->
				...
				<div class=" col-md-4 col-sm-6 about-innergrids">
					<div class="agileits-news-gridtext">
						...
						<div class="news-gridimgtext">
							...
							<p>Handling basic repairs and maintenance. Diagnosing mechanical issues and correcting them. Repairing machines, equipment as necessary. </p>
						</div>
					</div>
				</div>
				<div class=" col-md-4 col-sm-6 about-innergrids">
					<div class="agileits-news-gridtext">
						...
						<div class="news-gridimgtext">
							...
							<p>General repair workers fix and maintain machines. They often carry out many different tasks in a single day.provide the best service. </p>
						</div>
					</div>
				</div>
				<div class=" col-md-4 col-sm-6 about-innergrids">
					<div class="agileits-news-gridtext">
						...
						<div class="news-gridimgtext">
							...
							<p>Book well-trained plumbers for all plumbing issues like leaking taps, pipes, washbasins & other sanitary works.provide proffessional efficient and reliable plumbing services </p>
						</div>
					</div>
				</div>
				<div class=" col-md-4 col-sm-6 about-innergrids">
					<div class="agileits-news-gridtext">
						...
						<div class="news-gridimgtext">
							<a href="single.html">
								<h4>cleaning</h4>
								<p>Get spotless home cleaning services from experts at a reasonable cost with the best quality eco-friendly products. We provide the best service to sparkle every corner of your house.</p>
						</div>
					</div>
				</div>
				<div class=" col-md-4 col-sm-6 about-innergrids">
					<div class="agileits-news-gridtext">
						...
						<div class="news-gridimgtext">
							...
							<p>Electrical contractors may complete many different tasks.Maintenance duties include inspecting electrical equipment, replacing worn parts and repairing complex devices.Handling basic electrical works. </p>
						</div>
					</div>
				</div>
				...
				<div class=" col-md-4 col-sm-6 about-innergrids">
					<div class="agileits-news-gridtext">
						...
						<div class="news-gridimgtext">
							...
							<p>Professional painters prepare and paint interior and exterior surfaces.  Job duties for professional painters include removing old paint, choosing materials, selecting and mixing colors. </p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
