...
<?php 
    include 'co.php';
     $se= "select * from bookservice,addservice ";
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header">
            <h5 class="card-header-text">Booking History</h5>
          </div>
          <div class="card-block accordion-block">
            <div id="accordion" role="tablist" aria-multiselectable="true">
              <div class="accordion-panel">
               ...
               <strong>Service Name:</strong>    <?php
              echo $row['service'];
              ?>
                    </a>
                  </h3>
          ...
          <strong> Schedule Date:</strong>     <?php
