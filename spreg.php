...
<body>
	...
	<div class="breadcrumbs-w3l" style="background: #03b9f8;">
		<div class="container">
			<span class="breadcrumbs">
				<a href="index.html">Home</a> |
				<span>Service provider registeration
				</span>
			</span>
		</div>
	</div>
	...
	<div class="w3ls-section banner-single" id="register">
		<div class="container">
			...
			<form action="spreg.php" name="myform"  method="post" class="banner_form" onsubmit="return validateform()" enctype="multipart/form-data">
						...
						<div class="form-select sec-left">
							<label class="contact-form-text">Gender </label><br>
							<select name="gender" style="width:445px;">
						...
						<div class="sec-left">
							...
							<input type="date" name="dob" style="width:445px;height:45px;" min="1970-01-01" max="2001-12-31">
						</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 footer-grid1 address">
						...
						<ul>
							...
							<li>
								...
								<a href="mailto:info@example.com">johnmeenu.john15@gmail.com</a>
							</li>
							<li>
								<span class="fa fa-phone" aria-hidden="true"></span>
								<p>9495334861</p>
...
if(mysqli_query($con,$sq))
{
 $s=mysqli_query($con,"select logid from login where username='$i' ");
    ...
    $sql="insert into spreg(logid,name,phoneno,gender,dob,disid,city,address,sid,idproof)values('$lid','$a', '$b' , '$c', '$d' ,'$e', '$f', '$g', '$h','$img')";
